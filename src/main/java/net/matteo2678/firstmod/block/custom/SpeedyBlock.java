package net.matteo2678.firstmod.block.custom;
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if(world.isClient()) {
            if(hand == Hand.MAIN_HAND) {
                player.sendMessage(Text.translatable("CLIENT: This is THE CLIENT! MAIN HAND!"), false);
            } else {
                player.sendMessage(Text.translatable("CLIENT: This is THE CLIENT! OFF HAND!"), false);
            }
        }
